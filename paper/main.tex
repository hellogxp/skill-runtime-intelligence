...
\paragraph{Artifact.}
Public \href{https://github.com/hellogxp/skill-runtime-intelligence}{source} and the
\href{https://github.com/hellogxp/skill-runtime-intelligence-supplementary/releases/tag/profes-2026-submission-v1}{frozen artifact}
map tables to scripts, fixtures, and JSON reports.
...
\href{https://github.com/hellogxp/skill-runtime-intelligence/releases/tag/profes-2026-artifact-v2}{data release}
